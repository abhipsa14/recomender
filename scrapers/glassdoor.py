...
class GlassDoorScraper(BaseScraper):
    """GlassDoor job scraper with enhanced features"""
    ...
    def __init__(self, delay: float = 3.0):
        """Initialize GlassDoor scraper with longer delay for respect"""
...
def test_glassdoor_scraper():
    """Test function for GlassDoor scraper"""
    scraper = GlassDoorScraper()
    jobs = scraper.scrape_jobs("Python Developer", "New York", 1)

    print(f"\n🧪 GlassDoor Test Results: Found {len(jobs)} jobs")
